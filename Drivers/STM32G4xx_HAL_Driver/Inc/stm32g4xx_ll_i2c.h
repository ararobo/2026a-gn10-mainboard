...
#define LL_I2C_ADDRESSING_MODE_10BIT I2C_CR2_ADD10 /*!< Master operates in 10-bit addressing \
                                                      mode.*/
/**
 * @}
 */
...
#define __LL_I2C_CONVERT_TIMINGS(                                                    \
    __PRESCALER__, __SETUP_TIME__, __HOLD_TIME__, __SCLH_PERIOD__, __SCLL_PERIOD__   \
)                                                                                    \
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_I2C_ConfigFilters(
    I2C_TypeDef *I2Cx, uint32_t AnalogFilter, uint32_t DigitalFilter
)
{
    MODIFY_REG(
        I2Cx->CR1, I2C_CR1_ANFOFF | I2C_CR1_DNF, AnalogFilter | (DigitalFilter << I2C_CR1_DNF_Pos)
    );
}
...
__STATIC_INLINE void LL_I2C_ConfigSMBusTimeout(
    I2C_TypeDef *I2Cx, uint32_t TimeoutA, uint32_t TimeoutAMode, uint32_t TimeoutB
)
{
    MODIFY_REG(
        I2Cx->TIMEOUTR,
